  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--cream)", fontFamily: "'Golos Text', sans-serif" }}>
      <Helmet>
        ...
        <meta name="keywords" content="купить щенка мальтипу, купить щенка кавапу, купить щенка йорка, купить щенка той-пуделя, щенок бивер йорк купить, мальтипу щенки с документами, гипоаллергенная собака маленькая, собака которая не линяет, собака для квартиры маленькая, декоративные породы собак, питомник мальтипу Беларусь, питомник йорков Минск, купить щенка с документами UCI, щенки с микрочипом и прививками, доставка щенков по СНГ" />
