    ...
    <div className="min-h-screen" style={{ background: "var(--cream)", fontFamily: "'Golos Text', sans-serif" }}>
      ...
      <section id="home" className="relative min-h-screen flex items-center pt-16" style={{ background: "linear-gradient(135deg, #FAF6F0 0%, #F5EAD8 50%, #FAF0F2 100%)" }}>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute text-3xl" style={{ bottom: "10%", left: "5%",   opacity: 0.22, transform: "rotate(50deg) scaleX(-1)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "17%", left: "10%",  opacity: 0.22, transform: "rotate(50deg)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "24%", left: "16%",  opacity: 0.22, transform: "rotate(50deg) scaleX(-1)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "31%", left: "21%",  opacity: 0.22, transform: "rotate(50deg)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "38%", left: "27%",  opacity: 0.22, transform: "rotate(50deg) scaleX(-1)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "45%", left: "32%",  opacity: 0.22, transform: "rotate(50deg)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "52%", left: "38%",  opacity: 0.22, transform: "rotate(50deg) scaleX(-1)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "59%", left: "43%",  opacity: 0.22, transform: "rotate(50deg)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "66%", left: "49%",  opacity: 0.22, transform: "rotate(50deg) scaleX(-1)" }}>🐾</div>
          <div className="absolute text-3xl" style={{ bottom: "73%", left: "54%",  opacity: 0.22, transform: "rotate(50deg)" }}>🐾</div>
        </div>
