    ...
    <section id="gallery" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          <div className="text-sm font-medium tracking-widest uppercase mb-3" style={{ color: "var(--brown-light)", fontFamily: "'Golos Text', sans-serif" }}>Галерея</div>
        ...
        <div className="text-center mt-10">
          <button
            ...
            style={{ background: "var(--brown-light)", color: "white", fontFamily: "'Golos Text', sans-serif" }}
          >
