    ...
    <section id="reviews" className="py-16 sm:py-24" style={{ background: "var(--cream)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10 sm:mb-14">
          <div className="text-sm font-medium tracking-widest uppercase mb-3" style={{ color: "var(--brown-light)", fontFamily: "'Golos Text', sans-serif" }}>Отзывы</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="rounded-3xl p-6 sm:p-10 lg:p-14" style={{ background: "white" }}>
          <div className="text-center mb-10">
            <div className="text-sm font-medium tracking-widest uppercase mb-3" style={{ color: "var(--brown-light)", fontFamily: "'Golos Text', sans-serif" }}>Документы и гарантии</div>
